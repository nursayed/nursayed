...
- [Microinteractions: Password Validation Animation](https://dev.to/nursayed/microinteractions-password-validation-animation-5629)
- [Notion + YouTube - A Powerful Combination for Productivity](https://dev.to/nursayed/notion-youtube-a-powerful-combination-for-productivity-1def)
- [Regular Expressions (RegEx) Crash Course](https://dev.to/nursayed/regular-expressions-regex-crash-course-248n)
- [Emmet Part 2 - Advanced](https://dev.to/nursayed/emmet-part-2-advanced-4c65)
- [Deno 1.0 Released! (Easy) REST API Example](https://dev.to/nursayed/deno-1-0-released-easy-rest-api-example-2fbl)
<!-- BLOG-POST-LIST:END -->
